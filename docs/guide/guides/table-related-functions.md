---
sidebar_position: 4
description: Select, move, copy, and duplicate tables and memos, set colors and view options, define indexes, choose a database, get around the canvas, and compare documents.
---
